  ...
  <!-- <nav class="navbar navbar-default"> -->
    <div class="navbar-header">
      <span v-show="!$auth.check()">
        <quick-menu :menu-count=2 :icon-class=icons :menu-url-list=[<router-link :to="{name: 'login'}">login</router-link>, <router-link :to="{name: 'Hello'}">Hello</router-link>]></quick-menu>
      </span>
      <ul class="menu">
        <span v-show="!$auth.check()">
          <li class="menu">
